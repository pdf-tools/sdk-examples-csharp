...
This kit contains the AddAppearanceSignatureField sample for Pdftools SDK for C#. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
Run this sample from the command line or in Visual Studio.

### Prerequisites

Any supported version of .NET installed:
...
1. Run in the sample folder:
    `dotnet run --framework net8.0 --project PdfToolsAddAppearanceSignatureField.csproj <certificateFile> <password> <appConfigFile> <inputPath> <outputPath>`

### Visual Studio

1. Install Visual Studio 2022 or later.
2. Double-click `PdfToolsAddAppearanceSignatureField.csproj`.
3. Compile the project in Visual Studio.
4. Run:
    `PdfToolsAddAppearanceSignatureField.exe <certificateFile> <password> <appConfigFile> <inputPath> <outputPath>`

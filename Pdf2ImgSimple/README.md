...
This kit contains the Pdf2ImgSimple sample for Pdftools SDK for C#. Pdftools SDK is a development library that lets you integrate PDF processing into your applications. For more information, review the Pdftools [documentation portal](https://www.pdf-tools.com/docs/).
...
1. Run in the sample folder:
    `dotnet run --framework net8.0 --project PdfToolsPdf2ImgSimple.csproj <inputPath> <outputPath>`

### Visual Studio

1. Install Visual Studio 2022 or later.
2. Double-click `PdfToolsPdf2ImgSimple.csproj`.
3. Compile the project in Visual Studio.
4. Run:
    `PdfToolsPdf2ImgSimple.exe <inputPath> <outputPath>`
